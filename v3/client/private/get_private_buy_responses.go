...
func (o *GetPrivateBuyOK) Error() string {
	return fmt.Sprintf("[GET /private/buy][%d] getPrivateBuyOK  %+v", 200, o.Payload)
}
...
func (o *GetPrivateBuyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
