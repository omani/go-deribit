...
import (
	...
	models "github.com/omani/go-deribit/v3/models"
)
...
func (o *GetPrivateGetOrderHistoryByInstrumentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetPrivateGetOrderHistoryByInstrumentOK()
...
func NewGetPrivateGetOrderHistoryByInstrumentOK() *GetPrivateGetOrderHistoryByInstrumentOK {
	return &GetPrivateGetOrderHistoryByInstrumentOK{}
}
...
func (o *GetPrivateGetOrderHistoryByInstrumentOK) Error() string {
	return fmt.Sprintf("[GET /private/get_order_history_by_instrument][%d] getPrivateGetOrderHistoryByInstrumentOK  %+v", 200, o.Payload)
}
...
func (o *GetPrivateGetOrderHistoryByInstrumentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
